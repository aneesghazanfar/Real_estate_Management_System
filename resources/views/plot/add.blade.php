...
<form action="{{route ('plot.store')}}" method="post">
  ...
  <label for="plot_no"><b>Plot No:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
    <input class="UserInput" type="text" id="plot_no" name="plot_no"  placeholder="Enter Plot Number" size="30px"><br><br>
   ...
   <br><br>
    ...
    <input class="UserInput" type="text" id="dimensions" name="dimensions" placeholder="Enter Dimensions of Plot" size="30px"  ><br><br>
